...
class TestLoginRateLimit:
    ...
    def test_login_limit_rejects_repeated_attempts(self) -> None:
        ...
        # Act / Assert
        assert auth_module._check_login_rate_limit("198.51.100.10", "acme", "Alice", 2) is True  # noqa: SLF001
        assert auth_module._check_login_rate_limit("198.51.100.10", "acme", "Alice", 2) is True  # noqa: SLF001
        assert auth_module._check_login_rate_limit("198.51.100.10", "acme", "Alice", 2) is False  # noqa: SLF001
        assert auth_module._check_login_rate_limit("198.51.100.10", "other", "Alice", 2) is True  # noqa: SLF001
