...
| 21.2.4 | 注册开关 | `src/config.py`、`src/api/auth.py` | registration_enabled 默认关闭，公开注册仅创建默认租户 analyst | 单测完成 | P0 |
...
| # | 功能 | 文件 | 描述 | 状态 | 优先级 |
|---|------|------|------|------|--------|
| 21.4.1 | 登录与注册入口 | `LoginPage.tsx`、`AuthContext.tsx` | 强制跳转登录并按服务端开关展示注册 | 单测完成 | P0 |
